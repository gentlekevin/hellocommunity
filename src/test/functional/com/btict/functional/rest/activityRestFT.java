 ...
 * @author kevin
 */
public class activityRestFT extends BaseFunctionalTestCase {

	private static String resourceUrl = baseUrl + "/rest/activity";
...
*/	
	...
	@Category(Smoke.class)
	public void findCommunityByCityId() {
		String location = resourceUrl+"/findActivityList";
		System.out.println(location);
		MultiValueMap<String, Object> param = new LinkedMultiValueMap<>();

		Map map = new HashMap<>();
		map.put("communityId", "6");
