 ...
 * @author kevin
 */
public class repairRestFT extends BaseFunctionalTestCase {

	private static String resourceUrl = baseUrl + "/rest/repair";
...
*/	
	...
	@Category(Smoke.class)
	public void findCommunityByCityId() {
		String location = resourceUrl+"/findRepairList";
		System.out.println(location);
		MultiValueMap<String, Object> param = new LinkedMultiValueMap<>();
