 ...
 * @author kevin
 */
public class CityRestFT extends BaseFunctionalTestCase {
	...
	public void findAllCity() {
		String location = resourceUrl+"/city/findAll";
		System.out.println(location);
		String string = restTemplate.postForObject(location,null , String.class);
	...
	public void findCommunityByCityId() {
		String location = resourceUrl+"/community/findByCityId";
		System.out.println(location);
